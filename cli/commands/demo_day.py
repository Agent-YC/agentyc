...
def demo_day(ctx: click.Context, spec: str) -> None:
    ...
    if not eval_result_dict:
        console.print("[red]✗[/red] You cannot pitch at Demo Day without an evaluation.")
    ...
    if scores < 75:
        ...
        console.print("  YC Partners recommend a score of 75+ (Graduated) before Demo Day.")
    ...
    console.print(f"[dim]Stepping onto the stage at Pier 48... Pitching [bold]{agent_spec.name}[/bold].[/dim]")
    ...
    table = Table(title="📝 YC Term Sheet (Simulated)", border_style="gold3", title_style="bold gold3")
